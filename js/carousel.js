			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<a id="btnCarouselCine" role="button">
						<img src="https://res.cloudinary.com/togno43/image/upload/v1653920287/togno43/image01_dzp6ch_nunabm.jpg" class="d-block w-100" alt="Imagen 1">
				...
				<div class="carousel-item">
					<a id="btnCarouselTeatro" role="button">
						<img src="https://res.cloudinary.com/togno43/image/upload/v1653920287/togno43/image02_lw3yti_b9ezuk.jpg" class="d-block w-100" alt="Imagen 2">
						<div class="carousel-caption d-md-block">              
							<h5>TEATRO</h5>              
				...
				<div class="carousel-item">
					<a id="btnCarouselRecital" role="button">
						<img src="https://res.cloudinary.com/togno43/image/upload/v1653920287/togno43/image03_prneaj_yupht8.jpg" class="d-block w-100" alt="Imagen 3">
						<div class="carousel-caption d-md-block">         
							<h5>RECITALES</h5>             
